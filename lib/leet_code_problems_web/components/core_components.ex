defmodule LeetCodeProblemsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LeetCodeProblemsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LeetCodeProblemsWeb.Gettext, "errors", msg, opts)
    end
  end
